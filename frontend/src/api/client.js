...
export const api = {
  ...
  changePassword: (token, payload) => request('/auth/password', { method: 'PUT', body: payload, token }),
  deleteAccount: (token, password) => request('/auth/account', { method: 'DELETE', body: { password }, token }),
